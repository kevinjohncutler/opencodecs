...
# ---------------------------------------------------------------------------
# mrc — MRC2014 / CCP4 map (cryo-EM volumes, EMDB density maps)
# ---------------------------------------------------------------------------

from .._mrc_codec import MrcCodec
register_codec(MrcCodec())


# ---------------------------------------------------------------------------
# nifti — NIfTI-1 / NIfTI-2 (neuroimaging volumes)
# ---------------------------------------------------------------------------

from .._nifti_codec import NiftiCodec
register_codec(NiftiCodec())


# ---------------------------------------------------------------------------
# dicom — DICOM Part 10 files (.dcm)
# ---------------------------------------------------------------------------

from .._dicom_codec import DicomCodec
register_codec(DicomCodec())


# ---------------------------------------------------------------------------
# nrrd — Nearly Raw Raster Data (3D Slicer, ITK)
# ---------------------------------------------------------------------------

from .._nrrd_codec import NrrdCodec
register_codec(NrrdCodec())


# ---------------------------------------------------------------------------
# dm — Gatan Digital Micrograph (.dm3 / .dm4)
# ---------------------------------------------------------------------------

from .._dm_codec import DmCodec
register_codec(DmCodec())


# ---------------------------------------------------------------------------
# emd — Electron Microscopy Datasets (Berkeley/NCEM and Velox)
# ---------------------------------------------------------------------------

from .._emd_codec import EmdCodec
register_codec(EmdCodec())
